...
class BlueprintGenerator:
    ...
    def generate(self, user_config: dict, argparse_namespace: argparse.Namespace, **runtime_params) -> Blueprint:
        ...
        if runtime_params.get("architecture") == ARCHITECTURE_KREA2_EDIT:
            # The GUI persists these as task bookkeeping, while the generated dataset
            # TOML owns the ordered reference list used by Krea 2 Edit.
            dataset_local_arg_exclusions.update({"reference_directory", "reference_directories"})
        argparse_config = {
