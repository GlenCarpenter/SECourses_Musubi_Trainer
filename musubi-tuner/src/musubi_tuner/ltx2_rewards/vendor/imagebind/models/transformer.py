...
# Inference-only. Deviation from upstream:
#   - ``from timm.models.layers import DropPath, trunc_normal_`` -> inlined copies in
#     ``.._timm_compat`` (verbatim from timm; init-/train-time only, so the loaded-
#     checkpoint eval forward pass is identical).
...
from .._timm_compat import DropPath, trunc_normal_
